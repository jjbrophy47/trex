...
def create_csv(args, out_dir, logger):
    ...
    # organize results
    results = []
    for dataset, model, preprocessing, method, setting, start_pred, n_test, test in tqdm(experiment_settings):
...
if __name__ == '__main__':
    ...
    # I/O settings
    parser.add_argument('--in_dir', type=str, default='output/impact_high_loss/', help='input directory.')
    parser.add_argument('--out_dir', type=str, default='output/impact_high_loss/csv/', help='output directory.')
    ...
    parser.add_argument('--test', type=int, nargs='+', default=list(range(1, 200)), help='random state.')
