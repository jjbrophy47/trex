"""
Induce domain mismatch between train and test as follows:

1) Filter out 75% of the 395 people age <= 17 in the train data.
2) Flip the labels for 85% of the remaining samples.
"""
import sys
import os
import argparse
