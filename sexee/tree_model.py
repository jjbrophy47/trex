...
#     def __init__(self, tree_dump):
#         self.root_, self.n_nodes_ = self._parse_tree(tree_dump)
...
#     def _parse_tree(self, tree_str):
#         nodes = [self._get_node(node_str.strip()) for node_str in tree_str.split('\n') if node_str.strip() != '']
#         root = nodes[0]
#         n_nodes = len(nodes)
