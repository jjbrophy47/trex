...
class CBLeafInfluenceEnsemble(CatBoostEnsemble):
    ...
    def prediction_derivative(self, documents):
        return functools.reduce(lambda x, y: x + y, (tree(documents) for tree in self.influence_trees))
    ...
    def _top_k_leaves_idxs_set(self, k, t, removed_point_idx, da):
        ...
        return functools.reduce(lambda x, y: x | y, (tree._document_idxs_for_leaves[l] for l in leaf_idxs_to_update))| {removed_point_idx}
