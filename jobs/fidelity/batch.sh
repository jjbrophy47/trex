...
./jobs/fidelity/primer.sh 'vaccine' 'rf' 'standard' 250 7 10 1440 'short'
./jobs/fidelity/primer.sh 'amazon' 'rf' 'standard' 10 3 15 1440 'short'
./jobs/fidelity/primer.sh 'bank_marketing' 'rf' 'standard' 250 7 10 1440 'short'
./jobs/fidelity/primer.sh 'adult' 'rf' 'standard' 250 7 10 1440 'short'
./jobs/fidelity/primer.sh 'census' 'rf' 'standard' 10 7 15 1440 'short'
