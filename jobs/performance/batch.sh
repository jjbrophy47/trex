...
# RF
./jobs/performance/primer_single.sh 'churn' 'rf' 'standard' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'surgical' 'rf' 'standard' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'vaccine' 'rf' 'standard' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'amazon' 'rf' 'standard' 1.0 15 1440 'short'
./jobs/performance/primer_single.sh 'bank_marketing' 'rf' 'standard' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'adult' 'rf' 'standard' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'census' 'rf' 'standard' 1.0 15 1440 'short'
