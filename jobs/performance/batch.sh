...
# models that have greater memory requirements
...
./jobs/performance/primer_single.sh 'adult' 'cb' 'categorical' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'adult' 'cb' 'standard' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'census' 'cb' 'categorical' 1.0 10 1440 'short'
./jobs/performance/primer_single.sh 'census' 'cb' 'standard' 1.0 10 1440 'short'
