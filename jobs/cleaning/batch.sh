...
# ./jobs/cleaning/primer.sh 'vaccine' 'cb' 'standard' 250 5 0.18 1.0 'tree_output' 1.0 'tree_output' 61 2 900 'short'
./jobs/cleaning/primer.sh 'amazon' 'cb' 'standard' 250 7 0.1 1.0 'tree_output' 1.0 'feature_path' 7 25 1440 'short'
# ./jobs/cleaning/primer.sh 'bank_marketing' 'cb' 'standard' 250 5 0.18 1.0 'tree_output' 1.0 'tree_output' 31 2 900 'short'
# ./jobs/cleaning/primer.sh 'adult' 'cb' 'standard' 250 5 0.15 1.0 'tree_output' 1.0 'tree_output' 61 2 900 'short'
# ./jobs/cleaning/primer.sh 'census' 'cb' 'standard' 250 5 0.1 1.0 'tree_output' 1.0 'tree_output' 31 6 900 'short'
