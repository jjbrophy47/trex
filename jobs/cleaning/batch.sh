...
# TREX - RF
./jobs/cleaning/trex_primer.sh churn 250 10 0.3 1.0 3 1440 short
./jobs/cleaning/trex_primer.sh amazon 100 0 0.15 1.0 5 1440 short
./jobs/cleaning/trex_primer.sh adult 250 10 0.25 1.0 6 1440 short
./jobs/cleaning/trex_primer.sh census 250 5 0.15 0.1 15 1440 short
./jobs/cleaning/trex_primer.sh census 250 5 0.15 1.0 30 1440 short
...
# TEKNN - RF
./jobs/cleaning/teknn_primer.sh churn 250 10 0.3 1.0 3 1440 short
./jobs/cleaning/teknn_primer.sh amazon 100 0 0.15 1.0 5 1440 short
./jobs/cleaning/teknn_primer.sh adult 250 10 0.25 1.0 6 1440 short
./jobs/cleaning/teknn_primer.sh census 250 5 0.15 0.1 15 1440 short
./jobs/cleaning/teknn_primer.sh census 250 5 0.15 1.0 30 1440 short
...
# MAPLE - RF
./jobs/cleaning/maple_primer.sh churn 250 10 0.3 1.0 3 1440 short
./jobs/cleaning/maple_primer.sh amazon 100 0 0.15 1.0 5 1440 short
./jobs/cleaning/maple_primer.sh adult 250 10 0.25 1.0 6 1440 short
./jobs/cleaning/maple_primer.sh census 250 5 0.15 0.1 15 1440 short
./jobs/cleaning/maple_primer.sh census 250 5 0.15 1.0 20 1440 short
...
# TreeProto
./jobs/cleaning/proto_primer.sh churn 250 10 0.3 1.0 3 1440 short
./jobs/cleaning/proto_primer.sh amazon 100 0 0.15 1.0 5 1440 short
./jobs/cleaning/proto_primer.sh adult 250 10 0.25 1.0 6 1440 short
