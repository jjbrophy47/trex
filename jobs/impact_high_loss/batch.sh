...
./jobs/impact_high_loss/primer.sh 'surgical'       'cb' 'standard' 250 5 2  300  'short'
./jobs/impact_high_loss/primer.sh 'vaccine'        'cb' 'standard' 250 5 15 300  'short'
./jobs/impact_high_loss/primer.sh 'bank_marketing' 'cb' 'standard' 250 5 15 300  'short'
./jobs/impact_high_loss/primer.sh 'adult'          'cb' 'standard' 250 5 15 300  'short'
