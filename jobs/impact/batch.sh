...
./jobs/impact/primer.sh 'census'         'rf' 'standard'    250 7 45 300 'short'
...
./jobs/impact/primer_multi.sh 'amazon'         'cb' 'standard' 250 7 25 2880 'long'
...
./jobs/impact/primer_multi.sh 'census'         'rf' 'standard'    250 7 45 300 'short'
